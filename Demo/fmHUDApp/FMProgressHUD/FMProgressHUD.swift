...
class FMProgressHUD: UIView {
    ...
    dynamic var defaultMaskType = FMProgressHUDMaskType.none
    ...
    static var sharedView =  FMProgressHUD(frame: UIScreen.main.bounds)
    ...
    override init(frame: CGRect) {
        ...
        accessibilityIdentifier = "FMProgressHUD"
...
//        statusLabel.color
        ...
        if progress != FMProgressHUD.UNDEFINED_PROGRESS {
        ...
        DispatchQueue.main.async { [weak self] in
            ...
            let completionBlock = { [weak self] (_: Bool) in
                ...
                if self.backgroundView.alpha == 0 {
                    ...
                    self.progress = FMProgressHUD.UNDEFINED_PROGRESS
    ...
    static func showProgress(progress: CGFloat, status: String? = nil) {
        FMProgressHUD.sharedView.showProgress(progress: progress, status: status)
    }
